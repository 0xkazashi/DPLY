...
const Problems: FC = () => {
  return (
    <section id="problems" className="w-full bg-black bg-dot-grid flex justify-center items-center px-4 py-20 bg-transparent">
      <div className="w-full max-w-5xl text-center">
        ...
        <motion.div
          ...
          className="inline-block bg-white/10 border border-white text-white text-xs font-semibold px-3 py-1 rounded mb-6 w-fit relative z-10"
        >
